...
let
  sources = {
    ...
    "@types/mongodb-3.6.3" = {
      ...
      version = "3.6.3";
      src = fetchurl {
        url = "https://registry.npmjs.org/@types/mongodb/-/mongodb-3.6.3.tgz";
        sha512 = "6YNqGP1hk5bjUFaim+QoFFuI61WjHiHE1BNeB41TA00Xd2K7zG4lcWyLLq/XtIp36uMavvS5hoAUJ+1u/GcX2Q==";
      };
    };
    "@types/node-14.14.22" = {
    ...
    "connect-assets-6.0.1" = {
      name = "connect-assets";
      packageName = "connect-assets";
      version = "6.0.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/connect-assets/-/connect-assets-6.0.1.tgz";
        sha512 = "5pKA92HbbKIka2ToIXz8UuQUZwxfijHtkAfIsvcB4bLrYCpaoclT4z4muZ24WnCaTol8k+HqJkgL9rsukmiWvA==";
      };
    };
    "connect-flash-0.1.1" = {
      name = "connect-flash";
    ...
    "csswring-5.0.0" = {
      ...
      version = "5.0.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/csswring/-/csswring-5.0.0.tgz";
        sha1 = "b06fc18ead33426f593953300aa80b4cecd08d6f";
      };
    };
    "dashdash-1.14.1" = {
      name = "dashdash";
    ...
    "hike-1.0.2" = {
      ...
      version = "1.0.2";
      src = fetchurl {
        url = "https://registry.npmjs.org/hike/-/hike-1.0.2.tgz";
        sha1 = "59aa053e8939163b2b1faf891a4264290a64867a";
      };
    };
    ...
    "mimoza-1.0.0" = {
      ...
      version = "1.0.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/mimoza/-/mimoza-1.0.0.tgz";
        sha1 = "d74aa4fe08932f005e430bdc7bfcfa95fcab4e62";
      };
    };
    "mincer-2.0.1" = {
      name = "mincer";
      ...
      version = "2.0.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/mincer/-/mincer-2.0.1.tgz";
        sha512 = "1/5hE5SniEy3h4rhCHbTfIzVd6YTrl6s1MZ8ynTwTVMfY189CXVSl5+THlPuEBKLmtb/tOkSoiDlhDWfbLUYgg==";
      };
    };
    "minimatch-3.0.4" = {
      name = "minimatch";
    ...
    "mongoose-5.11.5" = {
      ...
      version = "5.11.5";
      src = fetchurl {
        url = "https://registry.npmjs.org/mongoose/-/mongoose-5.11.5.tgz";
        sha512 = "uwSeALQ1+qamUZBrIe1D6/uCzlHvcSbNQPG9w02DJqF3VHJSFOX1RdoxJE/wTN6WW7tTV8NMdLDSdxKqfo8J1A==";
      };
    };
    ...
    "mpath-0.8.0" = {
      ...
      version = "0.8.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/mpath/-/mpath-0.8.0.tgz";
        sha512 = "slIifXzF6pBxKpPV47ScgqWfGgkpwZNy55fY/umDrgmAxjWMz/WYzYsd8cThU49kw0rLyPWTZaWrOlazaeW57Q==";
      };
    };
    "mquery-3.2.2" = {
      name = "mquery";
    ...
    "passport-facebook-3.0.0" = {
      ...
      version = "3.0.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/passport-facebook/-/passport-facebook-3.0.0.tgz";
        sha512 = "K/qNzuFsFISYAyC1Nma4qgY/12V3RSLFdFVsPKXiKZt434wOvthFW1p7zKa1iQihQMRhaWorVE1o3Vi1o+ZgeQ==";
      };
    };
    "passport-google-0.3.0" = {
      name = "passport-google";
      packageName = "passport-google";
      version = "0.3.0";
      src = fetchurl {
    ...
    "passport-linkedin-1.0.0" = {
      ...
      packageName = "passport-linkedin";
      version = "1.0.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/passport-linkedin/-/passport-linkedin-1.0.0.tgz";
        sha1 = "e3300cf232f7e7b4b95710e238f0bb7936b5d85a";
      };
    };
  ...
  args = {
    ...
    dependencies = [
      ...
      sources."mimoza-1.0.0"
      sources."mincer-2.0.1"
      sources."minimatch-3.0.4"
      sources."minimist-1.2.5"
      sources."mkdirp-0.5.5"
      sources."mongodb-3.6.3"
      (sources."mongoose-5.11.5" // {
        dependencies = [
          sources."ms-2.1.2"
          sources."safe-buffer-5.2.1"
        ];
      ...
      sources."passport-facebook-3.0.0"
      sources."passport-google-0.3.0"
      sources."passport-linkedin-1.0.0"
      sources."passport-oauth1-1.1.0"
      sources."passport-oauth2-1.5.0"
      (sources."passport-openid-0.3.1" // {
        dependencies = [
          sources."passport-0.1.18"
        ];
      })
      sources."passport-strategy-1.0.0"
      sources."passport-twitter-1.0.4"
